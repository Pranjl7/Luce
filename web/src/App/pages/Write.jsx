...
function Write() {
  ...
  return (
    <>
      <main className='relative mx-auto flex max-h-[90vh] max-w-3xl flex-col gap-y-8 border-x border-black/10'>
        <div className='flex w-full items-center justify-between px-4 py-2'>
          ...
          <button onClick={() => setVisibility(true)} className='text-md cursor-pointer rounded-full bg-green-600 px-4 py-1 font-medium text-white transition duration-200 hover:bg-green-700'>
            Publish
          </button>
        </div>
        ...
        <PublishContent visibility={visibility} setVisibility={setVisibility}/>
      </main>
    </>
  );
}
